...
Inference by Enumeration: finding the probability distribution of variable X given observed evidence e and some hidden variables Y. $P(X \mid e) = \alpha\, P(X, e) = \alpha \sum_y P(X, e, y)$ \
